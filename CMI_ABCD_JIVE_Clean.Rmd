...
samp1_trauma_num <- left_join(samp1_ids, abcd_trauma_scored, by = "subjectkey")
samp2_trauma_num <- left_join(samp2_ids, abcd_trauma_scored, by = "subjectkey")
